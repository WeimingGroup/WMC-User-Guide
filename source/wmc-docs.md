...
| wmc-argon            | 存储服务器                     |         | 存储/域控            | Debian GNU/Linux 10 (buster) |
| wmc-slave-g16        | Amax 3090 * 10                  |   48    | 计算（长期下线，待处理）| Ubuntu 18.04.5 LTS |
| wmc-slave-g17        | Amax 3090 * 10                  |   48    | 计算（长期下线，待处理）| Ubuntu 18.04.6 LTS |
